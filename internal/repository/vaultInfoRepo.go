...
type VaultInfoRepository interface {
...
type mongoVaultInfoRepository struct {
...
func NewVaultConfig(dbName ,tvlCollection , trancheCollection , strategyCollection string) (*VaultInfoConfig) {
	return &VaultInfoConfig{
		DBName: dbName,
...
func NewMongoVaultInfoRepository(client *mongo.Client, cfg VaultInfoConfig) VaultInfoRepository {
	return &mongoVaultInfoRepository{
...
func (r *mongoVaultInfoRepository) GetTVL(ctx context.Context, vaultAddress string) (*model.BerafarmVaultTfv, error) {
...
func (r *mongoVaultInfoRepository) GetStrategies(ctx context.Context, vaultAddress string) (*model.BerafarmStrategyBalance, error) {
...
func (r *mongoVaultInfoRepository) GetTrancheAllocation(ctx context.Context, vaultAddress string) (*model.BerafarmTrancheData, error) {
